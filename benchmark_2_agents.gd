...
# Benchmark avec 2 AGENTS
# Compare l'efficacité d'avoir 2 agents pour 3 recettes
...
func _update_stats():
	...
	stats_label.text = "Agents: 2 | Complétées: %d | Ratées: %d | Vitesse: %.1f/min" % [recipes_completed, recipes_failed, recipes_per_min]

func _end_benchmark():
	set_process(false)
	print("\n============================================================")
	print("BENCHMARK TERMINÉ - 2 AGENTS")
	print("============================================================")
