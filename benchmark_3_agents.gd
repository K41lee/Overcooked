...
# Benchmark avec 3 AGENTS
# Compare l'efficacité d'avoir 3 agents pour 3 recettes (optimal)
...
func _update_stats():
	...
	stats_label.text = "Agents: 3 | Complétées: %d | Ratées: %d | Vitesse: %.1f/min" % [recipes_completed, recipes_failed, recipes_per_min]

func _end_benchmark():
	set_process(false)
	print("\n============================================================")
	print("BENCHMARK TERMINÉ - 3 AGENTS")
	print("============================================================")
